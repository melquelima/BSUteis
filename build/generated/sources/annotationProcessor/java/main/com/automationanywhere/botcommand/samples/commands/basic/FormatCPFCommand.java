...
public final class FormatCPFCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(FormatCPFCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    FormatCPF command = new FormatCPF();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.format_cpf((String)convertedParameters.get("value")));
