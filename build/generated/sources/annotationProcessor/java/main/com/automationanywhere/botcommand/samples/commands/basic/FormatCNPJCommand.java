...
public final class FormatCNPJCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(FormatCNPJCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    FormatCNPJ command = new FormatCNPJ();
